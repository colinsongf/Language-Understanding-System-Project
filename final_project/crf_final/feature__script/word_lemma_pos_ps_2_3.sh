...
paste word_lemma_pos data/prefix/prefix_train2  data/prefix/prefix_train3  data/suffix/suffix_train2 data/suffix/suffix_train3 > word_lemma_pos_s
...
paste word_lemma pos > word_lemma_pos
paste word_lemma_pos data/prefix/prefix_test2  data/prefix/prefix_test3  data/suffix/suffix_test2 data/suffix/suffix_test3 > word_lemma_pos_s
